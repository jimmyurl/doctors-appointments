...
class FeaturedCarouselWidget extends GetWidget<PatientController> {
  @override
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Obx(() {
        if (controller.recentDoctors.isEmpty) {
          return SizedBox();
        }
        return ListView.builder(
            ...
            itemCount: controller.recentDoctors.length,
            itemBuilder: (_, index) {
              var _doctor = controller.recentDoctors.elementAt(index);
