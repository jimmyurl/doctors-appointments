                      ...
                      children: [
                        ...
                        DoctorTilWidget(
                          ...
                          content: Obx(() {
                            ...
                            return Ui.applyHtml(_doctor.description, style: Get.textTheme.bodyLarge);
                          }),
                        ),
                        buildContactUs(),
                        ...
                        DoctorTilWidget(
                          ...
                          content: Column(
                            children: [
                              Text(_doctor.rate.toString(), style: Get.textTheme.displayLarge),
                              Wrap(
    ...
    return Padding(
      ...
      child: Wrap(
        ...
        children: List.generate(_doctor.specialities.length, (index) {
              ...
              return Container(
                padding: EdgeInsets.symmetric(horizontal: 10, vertical: 4),
                child: Text(_speciality.name, style: Get.textTheme.bodyLarge?.merge(TextStyle(color: _speciality.color))),
                decoration: BoxDecoration(
            ...
            List.generate(_doctor.subSpecialities.length, (index) {
              return Container(
                padding: EdgeInsets.symmetric(horizontal: 10, vertical: 4),
                child: Text(_doctor.subSpecialities.elementAt(index).name, style: Get.textTheme.bodySmall),
                decoration: BoxDecoration(
                    color: Get.theme.primaryColor,
                    border: Border.all(
    ...
    if (_doctor?.clinic?.hasData ?? false) {
      return GestureDetector(
        ...
        child: DoctorTilWidget(
          title: Text("Clinic".tr, style: Get.textTheme.titleSmall),
