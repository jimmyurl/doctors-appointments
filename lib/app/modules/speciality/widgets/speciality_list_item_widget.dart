...
class SpecialityListItemWidget extends StatelessWidget {
  ...
  SpecialityListItemWidget({Key? key, required this.speciality, this.heroTag, this.expanded}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Theme(
        ...
        child: ExpansionTile(
          initiallyExpanded: this.expanded ?? false,
          ...
          children: List.generate(speciality.subSpecialities?.length ?? 0, (index) {
            ...
            return GestureDetector(
              ...
              child: Container(
                ...
                child: Text(_speciality.name, style: Get.textTheme.bodyLarge),
