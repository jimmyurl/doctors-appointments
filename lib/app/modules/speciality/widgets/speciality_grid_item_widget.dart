...
class SpecialityGridItemWidget extends StatelessWidget {
  ...
  SpecialityGridItemWidget({Key? key, required this.speciality, required this.heroTag}) : super(key: key);
            ...
            Padding(
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  if ((speciality.subSpecialities?.length ?? 0) > 0) Divider(height: 25, thickness: 0.5,color: Get.theme.dividerColor,),
                  Wrap(
                    spacing: 5,
                    children: List.generate(speciality.subSpecialities?.length ?? 0, (index) {
                      ...
                      return GestureDetector(
                        ...
                        child: Container(
                          ...
                          child: Text(_speciality.name, style: Get.textTheme.bodySmall?.merge(TextStyle(fontSize: 10))),
