          ...
          children: [
                    ...
                    children: [
                      ...
                      Expanded(
                          child: Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              Text('${DateFormat.yMMMMEEEEd(Get.locale.toString()).format(controller.appointment.value.appointmentAt!)}', style: Get.textTheme.bodyMedium),
                              Text('${DateFormat('HH:mm', Get.locale.toString()).format(controller.appointment.value.appointmentAt!)}', style: Get.textTheme.bodyMedium),
                            ],
                          )),
                    ],
                  ),
            ...
            Container(
                ...
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text(controller.appointment.value.clinic.name, style: Get.textTheme.bodyLarge),
                    SizedBox(height: 8),
                    Row(
                      children: [
                            ...
                            return Column(
                              ...
                              children: [
                                (controller.appointment.value.clinic.address != null)
                                    ? Text(controller.appointment.value.clinic.address!.address, style: Get.textTheme.bodyMedium)
                                    : Text("Unknown Address".tr, style: Get.textTheme.bodyMedium),
                              ],
                            );
                          }),
                        ),
                            ...
                            return Column(
                              ...
                              children: [
                                (controller.appointment.value.address != null)
                                    ? Text(controller.appointment.value.address!.address, style: Get.textTheme.bodyMedium)
                                    : Text("Your Appointment at The Clinic Address.".tr, style: Get.textTheme.bodyMedium),
                              ],
                            );
                          }),
                        ),
                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      Expanded(
                        child: Obx(() {
                          return Text(controller.appointment.value.hint, style: Get.textTheme.bodyMedium);
                        }),
                      ),
                    ],
                  ),
